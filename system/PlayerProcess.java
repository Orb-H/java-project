...
public class PlayerProcess implements Callable<int[]> {
    ...
    public int[] call(){
        ...
        do {
            ...
            for(int i=0;i<3;++i) {
                if (op_string[i].equals("L")) op[i] = 0;
                else if (op_string[i].equals("R")) op[i] = 1;
                else if (op_string[i].equals("U")) op[i] = 2;
                else if (op_string[i].equals("D")) op[i] = 3;
                else if (op_string[i].equals("G")) op[i] = 4;
                else if (op_string[i].equals("C")) op[i] = 5;
                else {
                    try {
